...
import { auth, createUserWithEmailAndPassword, db, doc, setDoc } from '../../lib/firebase.js'
    ...
    <div className='w-full h-screen mt-0 mr-0 mb-10 ml-0 pt-10 pr-0'>
      <div className=' h-auto md:border-2 md:w-80 md:h-auto md:m-auto md:py-6 lg:items-end'>
        ...
        <div className='flex justify-center mt-3 min-w-72 text-center'>
          <p className='text-gray-500 text-base font-medium'>Sign up to see photos and videos <br /> from your friends.</p>
        </div>

        <div className=' bg-cyan-500 flex justify-center  w-60 mt-5 m-auto py-2 gap-2 rounded-md'>
          <Link href='/Facebook'>
            <Btn className='text-xs text-white font-bold ml-2' icon={faFacebook} style={{ color: 'white' }} value='Log in with Facebook' />
          </Link>
        ...
        <div className=' mt-16 h-20 flex flex-col justify-center items-center'>
          <form onSubmit={(e) => { e.preventDefault(); handleSubmit() }}>
            <Input
              ...
              className={"bg-slate-100 w-60 h-8 text-xs py-2 px-2 mb-2 rounded border-2 border-slate-300 "}
            />
            <Input
              type={"text"}
            ...
            <div className='bg-cyan-500 flex justify-center  w-60 mt-2 m-auto py-2 gap-2 rounded-md active:bg-cyan-800'>
              <input type="submit" value="Sign Up" className=' text-xs text-white font-bold' />
            </div>
          </form>
        ...
        <div className=' w-72 flex flex-col justify-center text-center text-gray-500 m-auto mt-20'>
          ...
          <p className='text-xs mt-7'>
            By signing up, you agree to our  <span className='font-medium text-cyan-800' >Terms</span>  ,
            <span className='font-medium text-cyan-800' >Privacy Policy</span> and
